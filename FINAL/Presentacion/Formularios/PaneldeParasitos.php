...
<div class="pagetitle">
<h3>Panel de Parásitos</h3>
    <nav>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="index.html">Home</a></li>
            <li class="breadcrumb-item">Formularios</li>
            <li class="breadcrumb-item active">Panel de Parásitos</li>
        </ol>
    </nav>
</div><!-- End Page Title -->
...
<form id="parasitePanelForm">
    ...
    <div class="form-group">
      <label for="antigenCP">Antígeno de Cryptosporidium parvum/dispar:</label>
      <select id="antigenCP" name="antigenCP">
        <option value="positive">Positivo</option>
        <option value="negative">Negativo</option>
