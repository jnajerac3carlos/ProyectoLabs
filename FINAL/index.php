...
<html lang="es">
    ...
    <head>
        ...
        <link href="Presentacion/Login/css/style.css" rel="stylesheet">
            ...
            <div class="container-fluid h-custom">
                <div
                    ...
                    <div class="col-md-9 col-lg-6 col-xl-5">
                        <img src="Presentacion/Login/img/medic.gif" class="img-fluid" alt="Clinica">
                    </div>
                    <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                        ...
                        <form id="loginform" action="Controllers/LoginController.php"  method="POST">
                            ...
                            <div class="d-flex flex-row  my-4">
                                <p class=" fw-bold mx-3 mb-0">Login</p>
                            </div>
                            ...
                            <div class="form-outline mb-3">
                                <input type="password" id="password"
                                    name="password"
                                    class="form-control form-control-lg" />
                                <label class="form-label" for="password">Ingresa
                                    tu contraseña</label>
                            </div>
                            ...
                            <div class="text-center text-lg-start mt-4 pt-2">
                                ...
                                <p class="small fw-bold mt-2 pt-1 mb-0">Don't
                                    have an account? <a href="Presentacion/Dashboard.html"
